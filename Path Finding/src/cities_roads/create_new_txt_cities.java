...
public class create_new_txt_cities {
	public static void main() throws IOException {
		...
		if(f.exists() && !f.isDirectory()) { 
			...
			try {
				...
				number_of_nodes=JOptionPane.showInputDialog("Please enter the number of new cities you will add.");
				out_new.println(number_of_nodes);
				do {
					name_of_node=JOptionPane.showInputDialog("Please enter the name of the new city. Leave blank to stop!");
					
					if(!name_of_node.isEmpty()) {
						
						Latitude_of_node=JOptionPane.showInputDialog("Please enter the latitude of the new city.");
						Longitude_of_node=JOptionPane.showInputDialog("Please enter the longitude of the new city.");
